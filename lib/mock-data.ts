...
export const initialFiles: File[] = [
  {
    ...
    comments: [
      {
        id: 'c1',
        author: 'Toufique Joarder',
        text: 'The server migration cost seems high. Can we negotiate with the vendor?',
        timestamp: '2025-12-07T11:00:00Z',
      },
      {
        id: 'c2',
        author: 'Rashida Begum',
        text: 'I will look into it and update the figures.',
  ...
  },
  {
    ...
    history: [
      { timestamp: '2025-12-01T15:00:00Z', actor: 'Toufique Joarder', event: 'Approved', stateChange: 'Approved', note: 'Policy looks solid. Go live next week.' },
  ...
  },
  {
    ...
    history: [
      { timestamp: '2025-12-02T16:30:00Z', actor: 'Toufique Joarder', event: 'Returned', stateChange: 'Returned', note: 'Cost is too high. Find a cheaper vendor and resubmit.' },
  ...
  },
  {
    ...
    history: [
      { timestamp: '2025-12-05T14:00:00Z', actor: 'Toufique Joarder', event: 'Approved', stateChange: 'Approved', note: 'Excellent work. Implement recommendations as scheduled.' },
